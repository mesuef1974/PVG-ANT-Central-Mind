...
| 5 | registry_sync_audit | three unknown suffix captures ending in `-WALL-001` | guard defect (false positive) | tokenizer captured the trailing suffix of longer identifiers as a standalone id; fixed with a negative lookbehind. No registry entry was missing. |
