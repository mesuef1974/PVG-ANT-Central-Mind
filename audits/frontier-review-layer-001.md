...
| **002** Multiplicative functions as observables | `analytic-number-theory` · `prime-valuation-geometry` (Halász/Delange/Wirsing/Selberg-Delange tools) | classification theorem (mean/cancellation types) | `WALL-PHASE` · `WALL-AVERAGE-NORMAL` | yes | **diagnose** (rich toolset; no new theorem) |
