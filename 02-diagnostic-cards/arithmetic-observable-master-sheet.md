...
Main wall:               (WALL-ID من 01-registries/walls.jsonl)
Registry IDs:            (TOOL-* / OBS-* المستعملة)
Known certificates:
Missing certificates:    (→ 05-certificate-ledger/missing-certificates.md)
Allowed claims:
Forbidden claims:
...
- `Main wall:` يجب أن يكون ID من `01-registries/walls.jsonl`.
