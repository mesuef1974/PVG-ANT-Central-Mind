...
> **نطاق:** مرجعٌ معروفٌ (Known). الأدواتُ المذكورة مسجَّلةٌ الآن في `01-registries/tools.jsonl` بعد إدخال Tenenbaum حتى 004-Z: `TOOL-HALASZ-001` · `TOOL-SELBERG-DELANGE-001` · `TOOL-WIRSING-001` · `TOOL-DELANGE-001`.
