...
Mileti-001-C  Metatheory vs Formal Theory                 (RULE-LOGIC-004)   next
...
**Next allowed:** `Mileti-001-C` (Metatheory vs Formal Theory, §1.3–1.4 → `RULE-LOGIC-004`) — awaiting explicit permission per scope-freeze.
