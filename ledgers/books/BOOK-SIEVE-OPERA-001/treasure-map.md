...
Review fields: source_grounded=true · duplicate_status=integration_only · scientific_class=Identity · trusted_status=provisional_intake
...
**Card summary:** 5 `new_function` (003 certificate law · 004/005/006 boundaries · 007 diagnostic) + 2 `integration_only` (001 identity · 002 normalization). All `trusted_status = provisional_intake`. Zero new TOOL-ID, zero new WALL-ID.
