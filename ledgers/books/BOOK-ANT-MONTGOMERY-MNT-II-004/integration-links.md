...
Book ID: `BOOK-ANT-MONTGOMERY-MNT-II-004`. **v0.6 — source-grounding-corrected (Correction 006).** طبقةُ الدمج: الكنوزُ المؤصَّلةُ على المصدر ← المهاراتُ والجبهاتُ الحيّة. **المسارُ الموثوق:** C (Ch 19-20 large sieve/BV) · D (Ch 21 sieves) · E (Ch 22 bounded gaps) · F (Ch 17 prime sums / Type I-II) · G (Ch 16 Van der Corput support)  · H (Ch 18 additive / circle method) — الستّةُ مُغلَقةٌ مُراجَعة. **محجور (cross-volume / source-mismatch):** A · B · legacy off-diagonal E.
...
Additive / circle method (H: 052-060)         → SKILL-MATH-ANT-001, SKILL-MATH-SIEVE-001
```
...
v0.6-g-closure PASS), H (Ch 18 additive / circle method, v0.6-h-closure PASS; from an explicit
