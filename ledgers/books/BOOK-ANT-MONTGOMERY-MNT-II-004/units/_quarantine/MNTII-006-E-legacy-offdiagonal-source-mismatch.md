# MNTII-006-E (LEGACY — source-mismatch, QUARANTINED) — Exponential and Kloosterman Sums

> **Status: source-mismatch / pre-packet / not trusted / not closed.**
> **Reason:** does not match Montgomery MNT-II Chapter 22 (bounded gaps) source scope. Created before the
> corrected protocol; its topic (exponential / Kloosterman off-diagonal cancellation) belongs to material
> the source defers to a later volume. Preserved for history; **NOT a trusted mined unit; NOT counted in
> the trusted treasure map.** Superseded by the source-grounded `units/MNTII-006-E.md` (bounded gaps /
> GPY / Maynard). See `audits/montgomery-source-grounding-correction-006.md`.

**Registry ID:** MNTII-006-E-LEGACY
**Status:** QUARANTINED (source-mismatch)
