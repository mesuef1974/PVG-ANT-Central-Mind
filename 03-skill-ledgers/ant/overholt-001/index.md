...
- `overholt-001-final-index.md` — الفهرسُ النهائيّ: 10 فصول (Ch1–Ch10) + وحدةُ تدريب، القوانين والهويّات والجدران وقواعد نقل PVG.
...
بطاقاتُ الدوال (μ, λ, squarefree) مسجَّلةٌ في `01-registries/observables.jsonl`؛ توسيعُها عند الطلب.
